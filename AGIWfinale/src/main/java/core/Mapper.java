...
public class Mapper {
	...
	public Mapper(String trmkt, String frbs, String relation)
			throws IOException {
	...
	public void getObject(String nameFile, String nameFileOutput,
			String nameFileOutput2) throws IOException {
		...
		try {
			...
			getObjectNoKey(subjectNoObject, writer2);
		} finally {
			br.close();
			writer.close();
			writer2.close();
	...
	public void getObjectNoKey(List<String> subjectNoObject, PrintWriter writer2) {
